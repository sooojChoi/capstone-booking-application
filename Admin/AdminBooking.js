...
import { doc, collection, addDoc, getDoc, getDocs, query, updateDoc, where, onSnapshot } from 'firebase/firestore';
...
export default function AdminBooking({ navigation }) {
  ...
  const SItem = ({ item, onPress }) => (
    <TouchableOpacity onPress={onPress}>
      <View style={{
        width: SCREEN_WIDTH * 0.9, height: SCREEN_HEIGHT * 0.08, borderBottomColor: "#c8c8c8",
        borderBottomWidth: 1, marginVertical: 2, marginHorizontal: SCREEN_WIDTH * 0.02
      }}>
  ...
  const Item = ({ item, onPress, backgroundColor, textColor }) => (
    <TouchableOpacity onPress={onPress} style={[styles.item, backgroundColor]}>
      ...
      <View style={{ width: SCREEN_WIDTH * 0.8, height: SCREEN_HEIGHT * 0.06, flexDirection: 'row', borderBottomColor: "#c8c8c8", borderBottomWidth: 1 }}>
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
      ...
      ></TextInput>
       */}
              <TouchableOpacity style={styles.textinput2} onPress={toggleSearchModal}>
                <Text style={{ fontSize: 14, color: "#828282" }}>{currentUserId ? currentUserId : "ID입력"}</Text>
            ...
            <View>
              <View style={{ height: showTimeSelect ? 400 : 0, width: showTimeSelect ? 400 : 0 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  ...
                  <Text style={{ ...styles.text3, marginLeft: 3, marginRight: 3 }}>{count}</Text>
      ...
      <TouchableOpacity
        style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: '#3262d4', paddingTop: 20, paddingBottom: 20 }}
        onPress={toggleModal}
      ...
      >
        <View style={{
          marginHorizontal: 10, height: SCREEN_HEIGHT * 0.7, width: SCREEN_WIDTH * 0.8,
          marginVertical: SCREEN_HEIGHT * 0.01, alignItems: 'center', justifyContent: 'center'
        }}>
          <FlatList
            data={data}
        ...
        <TouchableOpacity
          style={{ backgroundColor: '#3262d4', alignItems: 'center', borderRadius: 10, paddingVertical: 15, paddingHorizontal: 15, marginRight: 15 }}
          onPress={toggleTimeModal}
        >
