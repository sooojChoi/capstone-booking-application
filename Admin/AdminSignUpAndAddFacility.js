// 관리자 회원가입(세부시설 여러 개 추가하는 화면) -> 수진

import { StyleSheet, Text, View, Dimensions, Alert, TouchableOpacity, SafeAreaView } from 'react-native';
  ...
  useEffect(() => {
    ...
    if (name === undefined || name === "" || name === null) {
      ...
      facInfo.map((value) => {
        ...
        tempArray.push({
          name: facN, closeTime: closeTime, openTime: openTime,
